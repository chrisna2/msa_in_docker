...
# 2022-10-05 
지난 2019년에 내가 온 정신을 쏟았던 MSA가 이제는 모든 프로젝트 환경에서 대세가 되었다. 
대세가 된 현실에 조바심이 나서 지난날의 노력의 흔적인 이 프로젝트를 되살리려고 7일을 바쳤다. 성과는 미비하다.
그때는 부산은행의 프로젝트 일환으로 선행개발을 위해서 공부를 했던 것인데. 뭔가에 꽃혀서 주구장창 이 책과 이 프로젝트에 몰두 했었다.
그로 부터 3년이 지나 현재 진행된 프로젝트를 바라보니 절망 감회가 새롭다. 이거 한번 새로운 노트북에 살려 보겠다고 지난 일주일을 투자 했었다.
그런데 안올라간다. 버전이 많이 바뀌어서 그런지 메이븐 빌드 조차 실행이 안되는 것을 보며 깊은 현타가 온다.
한번에 모든 열정을 쏟는 만큼이나 중요한 것은 내가 공부하면서 올린 소스에 정기적인 확인이라는 것을 알게되었다.

환경 구성에 대한 지식은 언제나 바뀐다.
지나간 지식은 쏟을 때 만큼이나 다시 되살리는 것도 어렵다.
지난 2019년에 쏟은 4개월의 노력과 
그걸 되살리기 위해 쏟은 2022년의 7일간의 노력이 이제는 미련으로 남은 게 아닌가 두렵다.

끊임없이 유지하는 것, 꾸준히 하는 것, 그것을 잊지 않는 것

사실 이건 내가 개발자가 아니라도 지금 보다 더 나은 삶을 살아 가고자 하는 
지금의 나에게 중요한 시사점을 남겼다.

## 이 프로젝트를 되살리기 위해 날린 기회 비용
- 알고리즘 2강 진도 못나감
- 차라리 새롭게 프로젝트를 시작했다면 더 쉬웠을 거라는 생각
